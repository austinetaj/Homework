...
describe Dessert do
  ...
  let(:dessert){ Dessert.new("cupcake", 10, chef) }
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect{Dessert.new("Ice Cream", "Three", chef)}.to raise_error(ArgumentError)
    end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      shuffeled = dessert.mix!
      expect(shuffeled).not_to eq(ingredients)
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef John the Great Baker has made 10 cupcakes!")
    end
  end
